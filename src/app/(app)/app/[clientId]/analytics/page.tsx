...
import { Calendar, Download, Filter, TrendingUp, MessageSquare, Clock, Star, Users, AlertTriangle, CheckCircle } from 'lucide-react';
...
export default function AnalyticsDashboardPage({ params }: { params: { clientId: string } }) {
  ...
  const totalConversations = client.mascots.reduce((acc, bot) => acc + bot.conversations, 0);
  const avgResponseTime = client.mascots.reduce((acc, bot) => acc + bot.metrics.responseTime, 0) / client.mascots.length;
  const avgResolutionRate = client.mascots.reduce((acc, bot) => acc + bot.metrics.resolutionRate, 0) / client.mascots.length;
  const overallCsat = client.metrics.csat;
        ...
        <div className="container max-w-7xl mx-auto p-8">
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <h3 className="text-2xl font-bold">{overallCsat}</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-8">
            <div className="p-6 border-b">
              <h2 className="text-xl font-semibold">Bot Performance Comparison</h2>
            </div>

...
// Grey scale for charts (10 shades from black to white)
const GREYS = [
...
function getBrandTints(brandColor: string): string[] {
  return [
...
// Order: brand → black → white → then alternating greys and brand tints
function getChartColors(brandColor: string, count: number): string[] {
...
// Shared tooltip style (theme-aware) - fixes dark mode text visibility
const tooltipStyle = {
  contentStyle: {

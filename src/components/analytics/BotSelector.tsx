...
/**
 * BotSelector - A multi-select dropdown for selecting bots with workspace filtering.
 *
 * Features:
 * - Filters bots based on selected workspace
 * - Groups bots by workspace when "All Workspaces" is selected
 * - Shows flat list when a specific workspace is selected
 * - Supports multi-select with "All Bots" option
 *
 * Usage:
 * ```tsx
 * <BotSelector
